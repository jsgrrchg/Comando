...
|---|---|---|---|---|
| **Source** | TypeScript (`@agentclientprotocol/claude-agent-acp` `0.33.1`, vendored upstream snapshot) | Rust (`codex-acp` `0.12.0`, vendored on top of `openai/codex` `rust-v0.124.0` + local patches) | External Gemini CLI binary | External Kilo CLI binary |

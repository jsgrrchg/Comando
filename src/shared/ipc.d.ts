...
export declare const IPC_CHANNELS: {
    readonly getBootstrapSnapshot: "app:get-bootstrap-snapshot";
    readonly getPersistenceSnapshot: "app:get-persistence-snapshot";
    readonly getSettingsSnapshot: "settings:get-snapshot";
    readonly saveCodexRuntimeSettings: "settings:save-codex-runtime-settings";
    readonly getSystemTheme: "app:get-system-theme";
    readonly saveSettingsSnapshot: "settings:save-snapshot";
    readonly saveActiveProjectId: "app:save-active-project-id";
    readonly listProjects: "projects:list";
    readonly openProjects: "projects:open";
    readonly addProjectPaths: "projects:add-paths";
    readonly removeProject: "projects:remove";
    readonly touchProject: "projects:touch";
    readonly listProjectTree: "projects:list-tree";
    readonly openProjectFile: "projects:open-file";
    readonly saveProjectFile: "projects:save-file";
    readonly createProjectEntry: "projects:create-entry";
    readonly renameProjectEntry: "projects:rename-entry";
    readonly deleteProjectEntry: "projects:delete-entry";
    readonly revealProjectEntry: "projects:reveal-entry";
    readonly searchProjectEntries: "projects:search-entries";
    readonly getWorkspaceSnapshot: "workspace:get-snapshot";
    readonly saveWorkspaceSnapshot: "workspace:save-snapshot";
    readonly getChatSessionState: "workspace:get-chat-session-state";
    readonly createTerminalSession: "terminals:create-session";
    readonly writeTerminalInput: "terminals:write-input";
    readonly resizeTerminalSession: "terminals:resize-session";
    readonly closeTerminalSession: "terminals:close-session";
    readonly getAiRuntimeStatus: "ai:get-runtime-status";
    readonly getAiSessionSnapshot: "ai:get-session-snapshot";
    readonly sendAiPrompt: "ai:send-prompt";
    readonly cancelAiSession: "ai:cancel-session";
    readonly closeAiSession: "ai:close-session";
    readonly respondAiPermission: "ai:respond-permission";
    readonly keepAiTrackedFile: "ai:keep-tracked-file";
    readonly rejectAiTrackedFile: "ai:reject-tracked-file";
    readonly keepAllAiTrackedFiles: "ai:keep-all-tracked-files";
    readonly rejectAllAiTrackedFiles: "ai:reject-all-tracked-files";
};
export declare const IPC_EVENTS: {
    readonly projectTreeInvalidated: "projects:tree-invalidated";
    readonly themeUpdated: "app:theme-updated";
    readonly terminalData: "terminals:data";
    readonly terminalExit: "terminals:exit";
    readonly aiRuntimeStatus: "ai:runtime-status";
    readonly aiSessionSnapshot: "ai:session-snapshot";
};
export interface SystemTheme {
    readonly isDark: boolean;
}
export type PersistedShellSurface = "projects" | "workspace" | "utility" | "composer";
...
export type GitStatusBadge = "added" | "deleted" | "mixed" | "modified" | "untracked";
...
export type WorkspaceTab = WorkspaceFileTab | WorkspaceChatTab | WorkspaceReviewTab | WorkspaceTerminalTab;
...
export type AiSessionStatus = "error" | "idle" | "starting" | "streaming" | "waiting_permission";
...
export interface ComandoApi {
    ...
    listProjectTree: (input: ListProjectTreeInput) => Promise<ProjectTreeNode[]>;
    searchProjectEntries: (input: SearchProjectEntriesInput) => Promise<ProjectTreeNode[]>;
    openProjectFile: (input: OpenProjectFileInput) => Promise<ProjectFileDocument>;
    saveProjectFile: (input: SaveProjectFileInput) => Promise<ProjectFileDocument>;
    ...
    getChatSessionState: (sessionId: string) => Promise<PersistedChatSessionState | null>;
    getAiRuntimeStatus: (runtimeId: AiRuntimeId) => Promise<AiRuntimeStatus>;
    getAiSessionSnapshot: (sessionId: string) => Promise<AiSessionSnapshot | null>;
    ...
    saveCodexRuntimeSettings: (settings: CodexRuntimeSettings) => Promise<AiRuntimeStatus>;
    createTerminalSession: (input: CreateTerminalSessionInput) => Promise<TerminalSession>;
    ...
    onProjectTreeInvalidated: (listener: (payload: ProjectTreeInvalidation) => void) => () => void;
    onThemeUpdated: (listener: (theme: SystemTheme) => void) => () => void;
    onTerminalData: (listener: (event: TerminalDataEvent) => void) => () => void;
    onTerminalExit: (listener: (event: TerminalExitEvent) => void) => () => void;
    onAiRuntimeStatus: (listener: (status: AiRuntimeStatus) => void) => () => void;
    onAiSessionSnapshot: (listener: (snapshot: AiSessionSnapshot) => void) => () => void;
}

...
export function compute_diff_hunks_json(old_text: string, new_text: string, seed: string): string;

export function compute_line_diff_json(old_text: string, new_text: string): string;
...
export function resolve_tracked_file_hunks_json(file_json: string, hunk_ids_json: string, decision: string, updated_at: string): string;
...
export interface InitOutput {
    ...
    readonly compute_diff_hunks_json: (a: number, b: number, c: number, d: number, e: number, f: number) => [number, number, number, number];
    readonly compute_line_diff_json: (a: number, b: number, c: number, d: number) => [number, number, number, number];
    ...
    readonly resolve_tracked_file_hunks_json: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => [number, number, number, number];

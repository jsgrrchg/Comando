...
pub enum NativeErrorCode {
    ...
    AiRuntimeNotNative,
    AiRuntimeNotReady,
    AiRuntimeLaunchContextInvalid,
    AiRuntimeAuthMissing,
    AiSessionNotFound,
    AiSessionBusy,
...
impl NativeErrorCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::AiRuntimeLaunchContextInvalid => "ai_runtime_launch_context_invalid",
            Self::AiRuntimeAuthMissing => "ai_runtime_auth_missing",
